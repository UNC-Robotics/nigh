...
// generated_se3_pair_float_state_rw_batch_8_test.cpp
...
TEST(se3_pair_float_state_rw_batch_8) {
    using namespace unc::robotics::nigh;
    using namespace unc::robotics::nigh::metric;
    using namespace nigh_test;  
    using Metric = Cartesian<SO3, LP<2>>;
    using State = std::pair<Eigen::Quaternion<float>, Eigen::Matrix<float, 3, 1>>;
