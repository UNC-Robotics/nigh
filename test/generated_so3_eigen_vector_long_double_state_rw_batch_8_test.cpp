...
// generated_so3_eigen_vector_long_double_state_rw_batch_8_test.cpp
#include "sampler_so3.hpp"
#include <nigh/kdtree_batch.hpp>
#include "test_template.hpp"

TEST(so3_eigen_vector_long_double_state_rw_batch_8) {
    using namespace unc::robotics::nigh;
    using namespace unc::robotics::nigh::metric;
    using namespace nigh_test;  
    using Metric = SO3;
    using State = Eigen::Matrix<long double, 4, 1>;
