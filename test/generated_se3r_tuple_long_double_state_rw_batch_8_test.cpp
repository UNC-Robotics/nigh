...
// generated_se3r_tuple_long_double_state_rw_batch_8_test.cpp
...
TEST(se3r_tuple_long_double_state_rw_batch_8) {
    using namespace unc::robotics::nigh;
    using namespace unc::robotics::nigh::metric;
    using namespace nigh_test;  
    using Metric = Cartesian<LP<2>, SO3>;
    using State = std::tuple<Eigen::Matrix<long double, 3, 1>, Eigen::Quaternion<long double>>;
