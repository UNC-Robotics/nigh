...
// generated_se3_tuple_long_double_state_rw_batch_8_test.cpp
...
TEST(se3_tuple_long_double_state_rw_batch_8) {
    using namespace unc::robotics::nigh;
    using namespace unc::robotics::nigh::metric;
    using namespace nigh_test;  
    using Metric = Cartesian<SO3, LP<2>>;
    using State = std::tuple<Eigen::Quaternion<long double>, Eigen::Matrix<long double, 3, 1>>;
